...
public final class BitcoinIntegration {
    ...
    private static void startForResult(final Activity activity, final int requestCode, final Intent intent) {
        ...
        //檢測是否有存在的
        Log.i(String.valueOf(requestCode), "startForResult: requestCode");
        Log.i(intent.toURI(), "startForResult: intent.uri");
...
//                 String packageName = resolveInfo.activityInfo.packageName;// 包名String className = resolveInfo.activityInfo.name;// 入口类名
//                    System.out.println("程序名：" + appName + " 包名:" + packageName);
//        }
        ResolveInfo resolveInfo = pm.resolveActivity(intent, 0);
        System.out.println("包名:"+resolveInfo.toString());
        System.out.println("目標Activity:"+resolveInfo.activityInfo.targetActivity);
